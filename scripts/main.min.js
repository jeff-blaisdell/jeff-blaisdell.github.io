...
(function () {
  ...
  require.register('ecarter-css-emitter/index.js', function (exports, require, module) {
    ...
    function CssEmitter(element) {
      if (!(this instanceof CssEmitter))
        return new CssEmitter(element);
      this.el = element;
    }
  ...
  require.register('move/index.js', function (exports, require, module) {
    ...
    function Move(el) {
      ...
      if ('string' == typeof el)
        el = query(el);
      if (!el)
        throw new TypeError('Move must be initialized with element or selector');
      this.el = el;
      this._props = {};
      this._rotate = 0;
...
(function (T, V, s) {
    ...
    if (a) {
      ...
      if (O(b))
        for (var g = a.length = 0; g < b.length; g++)
          e = Ga(b[g], null, c, d), U(b[g]) && (c.push(b[g]), d.push(e)), a.push(e);
      else {
        var f = a.$$hashKey;
        q(a, function (b, c) {
          delete a[c];
        ...
        for (g in b)
          e = Ga(b[g], null, c, d), U(b[g]) && (c.push(b[g]), d.push(e)), a[g] = e;
        Yb(a, f);
      }
    } else
      (a = b) && (O(b) ? a = Ga(b, [], c, d) : Na(b) ? a = new Date(b.getTime()) : fb(b) ? a = RegExp(b.source) : U(b) && (a = Ga(b, {}, c, d)));
    return a;
  }
  function ka(b, a) {
    if (O(b)) {
      ...
      for (c in a = a || {}, b)
        !zb.call(b, c) || '$' === c.charAt(0) && '$' === c.charAt(1) || (a[c] = b[c]);
    return a || b;
  }
  function xa(b, a) {
    if (b === a)
    ...
    if (c == typeof a && 'object' == c)
      if (O(b)) {
        ...
        if (b && b.$evalAsync && b.$watch || a && a.$evalAsync && a.$watch || Ea(b) || Ea(a) || O(a))
          return !1;
        c = {};
        for (d in b)
          if ('$' !== d.charAt(0) && !Q(b[d])) {
        ...
        for (d in a)
          if (!c.hasOwnProperty(d) && '$' !== d.charAt(0) && a[d] !== s && !Q(a[d]))
            return !1;
        return !0;
      }
    return !1;
  ...
  function Ra(b) {
    'function' === typeof b ? b = !0 : b && 0 !== b.length ? (b = L('' + b), b = !('f' == b || '0' == b || 'false' == b || 'no' == b || 'n' == b || '[]' == b)) : b = !1;
    return b;
  }
  function ga(b) {
    b = w(b).clone();
  ...
  function cc(b) {
    ...
    q((b || '').split('&'), function (b) {
      b && (c = b.split('='), d = bc(c[0]), B(d) && (b = B(c[1]) ? bc(c[1]) : !0, a[d] ? O(a[d]) ? a[d].push(b) : a[d] = [
        a[d],
        b
      ] : a[d] = b));
    });
  ...
  function Fb(b, a, c, d) {
    function e(b) {
      var e = c && b ? [this.filter(b)] : [this], m = a, h, l, n, p, r, v;
      if (!d || null != b)
        for (; e.length;)
          for (h = e.shift(), l = 0, n = h.length; l < n; l++)
            for (p = w(h[l]), m ? p.triggerHandler('$destroy') : m = !m, r = 0, p = (v = p.children()).length; r < p; r++)
              e.push(Ba(v[r]));
    ...
    function e(a) {
      ...
      q(a, function (a) {
        if (!h.get(a)) {
          ...
          try {
            if (C(a))
              for (c = Ua(a), b = b.concat(e(c.requires)).concat(c._runBlocks), d = c._invokeQueue, g = 0, k = d.length; g < k; g++) {
                var f = d[g], m = n.get(f[0]);
                m[f[1]].apply(m, f[2]);
              }
            else
              Q(a) ? b.push(n.invoke(a)) : O(a) ? b.push(n.invoke(a)) : Ta(a, 'module');
          } catch (l) {
            throw O(a) && (a = a[a.length - 1]), l.message && (l.stack && -1 == l.stack.indexOf(l.message)) && (l = l.message + '\n' + l.stack), Za('modulerr', a, l.stack || l.message || l);
          }
        }
      });
      return b;
  ...
  function se(b, a, c, d) {
    ...
    var M = h.href, F = a.find('base'), z = null;
    k.url = function (a, c) {
      h !== b.location && (h = b.location);
      l !== b.history && (l = b.history);
      if (a) {
        if (M != a)
          return M = a, d.history ? c ? l.replaceState(null, '', a) : (l.pushState(null, '', a), F.attr('href', F.attr('href'))) : (z = a, c ? h.replace(a) : h.href = a), k;
      } else
    ...
    k.cookies = function (a, b) {
      var d, e, g, k;
      if (a)
        b === s ? m.cookie = escape(a) + '=;path=' + E + ';expires=Thu, 01 Jan 1970 00:00:00 GMT' : C(b) && (d = (m.cookie = escape(a) + '=' + escape(b) + ';path=' + E).length + 1, 4096 < d && c.warn('Cookie \'' + a + '\' possibly not set or overflowed because it was too large (' + d + ' > 4096 bytes)!'));
      else {
        if (m.cookie !== ca)
          for (ca = m.cookie, d = ca.split('; '), N = {}, g = 0; g < d.length; g++)
            e = d[g], k = e.indexOf('='), 0 < k && (a = unescape(e.substring(0, k)), N[a] === s && (N[a] = unescape(e.substring(k + 1))));
        return N;
      }
    };
      ...
      function b(b, d) {
        ...
        return a[b] = {
          put: function (a, b) {
            ...
            if (!D(b))
              return a in m || f++, m[a] = b, f > h && this.remove(p.key), b;
          },
          get: function (a) {
            if (h < Number.MAX_VALUE) {
              var b = l[a];
  ...
  function gc(b, a) {
    ...
    this.directive = function m(a, e) {
      Aa(a, 'directive');
      C(a) ? (Cb(e, 'directiveFactory'), c.hasOwnProperty(a) || (c[a] = [], b.factory(a + d, [
        '$injector',
        '$exceptionHandler',
        function (b, d) {
          var e = [];
    ...
    this.$get = [
      ...
      '$animate',
      '$$sanitizeUri',
      function (a, b, l, n, p, r, v, I, x, u, M, F) {
        ...
        function P(a, b, c, d, e, g) {
          function f(a, c, d, e) {
            ...
            for (n = 0; n < g; n++)
              K[n] = c[n];
            v = n = 0;
            for (p = m.length; n < p; v++)
              h = K[v], c = m[n++], g = m[n++], l = w(h), c ? (c.scope ? (r = a.$new(), l.data('$scope', r)) : r = a, l = c.transcludeOnThisElement ? N(a, c.transclude, e) : !c.templateOnThisElement && e ? e : !e && b ? N(a, b) : null, c(g, r, h, d, l)) : g && g(a, h.childNodes, s, e);
          }
          for (var m = [], h, l, r, n, p = 0; p < a.length; p++)
            h = new Lb(), l = ca(a[p], [], h, 0 === p ? d : s, e), (g = l.length ? H(l, a[p], h, b, c, null, [], [], g) : null) && g.scope && ha(w(a[p]), 'ng-scope'), h = g && g.terminal || !(r = a[p].childNodes) || !r.length ? null : P(r, g ? (g.transcludeOnThisElement || !g.templateOnThisElement) && g.transclude : b), m.push(g, h), n = n || g || h, g = null;
          return n ? f : null;
        }
        function N(a, b, c) {
          ...
          case 1:
            ...
            for (var p = 0, v = h && h.length; p < v; p++) {
              ...
              if (!S || 8 <= S || l.specified) {
                ...
                n === M + 'Start' && (x = r, I = r.substr(0, r.length - 5) + 'end', r = r.substr(0, r.length - 6));
                n = ma(r.toLowerCase());
                m[n] = r;
                c[n] = l = aa(l.value);
                qc(a, n) && (c[n] = !0);
            ...
            if (C(a) && '' !== a)
              for (; h = g.exec(a);)
                n = ma(h[2]), ba(b, n, 'C', d, f) && (c[n] = aa(h[3])), a = a.substr(h.index + h[0].length);
            break;
          case 3:
            t(b, a.nodeValue);
            break;
          case 8:
            try {
              if (h = e.exec(a.nodeValue))
                n = ma(h[1]), ba(b, n, 'M', d, f) && (c[n] = aa(h[2]));
            } catch (u) {
            }
          }
          b.sort(D);
        ...
        function H(a, c, d, e, g, f, m, n, p) {
          function x(a, b, c, d) {
            if (a) {
              ...
              a.require = G.require;
              a.directiveName = na;
              if (N === G || G.$$isolateScope)
                a = uc(a, { isolateScope: !0 });
              m.push(a);
            }
            if (b) {
              c && (b = A(b, c, d));
          ...
          function M(a, e, g, f, p) {
            ...
            for (z = m.length; f < z; f++)
              try {
                F = m[f], F(F.isolateScope ? E : e, K, u, F.require && I(F.directiveName, F.require, K, ca), nb);
              } catch (G) {
                l(G, ga(K));
              }
            f = e;
          ...
          p = p || {};
          for (var u = -Number.MAX_VALUE, F, P = p.controllerDirectives, N = p.newIsolateScopeDirective, H = p.templateDirective, ba = p.nonTlbTranscludeDirective, D = !1, J = !1, Ca = p.hasElementTranscludeDirective, t = d.$$element = w(c), G, na, X, T = e, R, S = 0, oa = a.length; S < oa; S++) {
            G = a[S];
            ...
            if (u > G.priority)
              break;
            if (X = G.scope)
              F = F || G, G.templateUrl || (L('new/isolated scope', N, G, t), U(X) && (N = G));
            na = G.name;
            !G.templateUrl && G.controller && (X = G.controller, P = P || {}, L('\'' + na + '\' controller', P[na], G, t), P[na] = G);
            if (X = G.transclude)
              D = !0, G.$$tlb || (L('transclusion', ba, G, t), ba = G), 'element' == X ? (Ca = !0, u = G.priority, X = E(c, W, Y), t = d.$$element = w(V.createComment(' ' + na + ': ' + d[na] + ' ')), c = t[0], ob(g, w(ya.call(X, 0)), c), T = z(X, e, u, f && f.name, { nonTlbTranscludeDirective: ba })) : (X = w(Jb(c)).contents(), t.empty(), T = z(X, e));
            if (G.template)
              if (J = !0, L('template', H, G, t), H = G, X = Q(G.template) ? G.template(t, d) : G.template, X = Z(X), G.replace) {
                f = G;
                X = Hb.test(X) ? w(aa(X)) : [];
                c = X[0];
                if (1 != X.length || 1 !== c.nodeType)
                  throw ia('tplrt', na, '');
                ob(g, t, c);
                oa = { $attr: {} };
                X = ca(c, [], oa);
                ...
                t.html(X);
            if (G.templateUrl)
              J = !0, L('template', H, G, t), H = G, G.replace && (f = G), M = y(a.splice(S, a.length - S), t, d, g, D && T, m, n, {
        ...
        function ob(a, b, c) {
          ...
          for (e = b.length; d < e; d++)
            g = b[d], w(g).remove(), a.appendChild(g), delete b[d];
          b[0] = c;
          b.length = 1;
        }
        function uc(a, b) {
        ...
        return function (e, g) {
          ...
          if (m) {
            if (!g || 'object' != typeof g.$scope)
              throw t('$controller')('noscp', k || e.name, m);
            g.$scope[m] = f;
          }
          return f;
        };
        ...
        function v(c, g, f) {
          ...
          if (A)
            if (H = A.get(w), B(H)) {
              ...
              A.put(w, q);
          D(H) && ((H = Mb(c.url) ? b.cookies()[c.xsrfCookieName || e.xsrfCookieName] : s) && (f[c.xsrfHeaderName || e.xsrfHeaderName] = H), a(c.method, w, g, h, f, c.timeout, c.withCredentials, c.responseType));
          return q;
        }
        function I(a, b) {
          if (!b)
  ...
  function ve(b) {
    if (8 >= S && (!b.match(/^(get|post|head|put|delete|options)$/i) || !T.XMLHttpRequest))
  ...
  function we(b, a, c, d, e) {
    function g(a, b, c) {
      ...
      8 >= S && (g.onreadystatechange = function () {
        C(g.readyState) && /loaded|complete/.test(g.readyState) && (g.onreadystatechange = null, f({ type: 'load' }));
      });
  ...
  function Rd() {
    ...
    this.$get = [
      ...
      function (c, d, e) {
        function g(g, h, l) {
          for (var n, p, r = 0, v = [], I = g.length, x = !1, u = []; r < I;)
            -1 != (n = g.indexOf(b, r)) && -1 != (p = g.indexOf(a, n + f)) ? (r != n && v.push(g.substring(r, n)), v.push(r = c(x = g.substring(n + f, p))), r.exp = x, r = p + k, x = !0) : (r != I && v.push(g.substring(r)), r = I);
          (I = v.length) || (v.push(''), I = 1);
          if (l && 1 < v.length)
            throw zc('noconcat', g);
          if (!h || x)
            return u.length = I, r = function (a) {
              try {
                for (var b = 0, c = I, f; b < c; b++) {
                  if ('function' == typeof (f = v[b]))
      ...
      function (c, d, e, g) {
        ...
        g.on('click', function (a) {
          if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
            for (var e = w(a.target); 'a' !== L(e[0].nodeName);)
            ...
            if (m === Rb) {
              ...
              if (0 > h.indexOf('://'))
                if (f = '#' + b, '/' == h[0])
                  ...
                  for (var l = k.path().split('/'), h = h.split('/'), p = 0; p < h.length; p++)
                    '.' != h[p] && ('..' == h[p] ? l.pop() : h[p].length && l.push(h[p]));
                  f = n + f + l.join('/');
                }
            }
            l = k.$$rewrite(f);
  ...
  function Ec(b, a, c, d, e, g, f) {
    ...
    return f.unwrapPromises ? function (f, m) {
      ...
      if (null == h)
        return h;
      (h = h[b]) && h.then && (ta(g), '$$v' in h || (l = h, l.$$v = s, l.then(function (a) {
        l.$$v = a;
      })), h = h.$$v);
      if (!a)
        return h;
      ...
      if (null == h)
        return s;
      (h = h[e]) && h.then && (ta(g), '$$v' in h || (l = h, l.$$v = s, l.then(function (a) {
        l.$$v = a;
      })), h = h.$$v);
      return h;
    } : function (g, f) {
  ...
  function Fc(b, a, c) {
    ...
    if (a.unwrapPromises || 1 !== e)
      if (a.unwrapPromises || 2 !== e)
        if (a.csp)
          g = 6 > e ? Ec(d[0], d[1], d[2], d[3], d[4], c, a) : function (b, g) {
            var f = 0, k;
            do
              k = Ec(d[f++], d[f++], d[f++], d[f++], d[f++], c, a)(b, g), g = s, b = k;
            while (f < e);
            return k;
          };
        else {
    ...
    this.$get = [
      ...
      function (d, e, g, f) {
        ...
        k.prototype = {
          ...
          $digest: function () {
            var d, g, f, k, h = this.$$asyncQueue, l = this.$$postDigestQueue, q, z, s = b, P, N = [], w, E, A;
            m('$digest');
            c = null;
            do {
              z = !1;
                ...
                do {
                  if (k = P.$$watchers)
                    for (q = k.length; q--;)
                      try {
                        if (d = k[q])
                          if ((g = d.get(P)) !== (f = d.last) && !(d.eq ? xa(g, f) : 'number' == typeof g && 'number' == typeof f && isNaN(g) && isNaN(f)))
                            z = !0, c = d, d.last = d.eq ? Ga(g, null) : g, d.fn(g, f === n ? g : f, P), 5 > s && (w = 4 - s, N[w] || (N[w] = []), E = Q(d.exp) ? 'fn: ' + (d.exp.name || d.exp.toString()) : d.exp, E += '; newVal: ' + ra(g) + '; oldVal: ' + ra(f), N[w].push(E));
                          else if (d === c) {
                            z = !1;
                            break a;
                          }
                  ...
                  if (!(k = P.$$childHead || P !== this && P.$$nextSibling))
                    for (; P !== this && !(k = P.$$nextSibling);)
                      P = P.$parent;
                } while (P = k);
              if ((z || h.length) && !s--)
                throw p.$$phase = null, a('infdig', b, ra(N));
            } while (z || h.length);
          ...
          getTrusted: function (c, d) {
            ...
            if (c === fa.RESOURCE_URL) {
              ...
              for (n = b.length; l < n; l++)
                if ('self' === b[l] ? Mb(g) : b[l].exec(g.href)) {
                  p = !0;
                  break;
                }
              if (p)
                for (l = 0, n = a.length; l < n; l++)
                  if ('self' === a[l] ? Mb(g) : a[l].exec(g.href)) {
                    p = !1;
                    break;
                  }
              if (p)
  ...
  function be() {
    this.$get = [
      ...
      '$document',
      function (b, a) {
        var c = {}, d = Z((/android (\d+)/.exec(L((b.navigator || {}).userAgent)) || [])[1]), e = /Boxee/i.test((b.navigator || {}).userAgent), g = a[0] || {}, f = g.documentMode, k, m = /^(Moz|webkit|O|ms)(?=[A-Z])/, h = g.body && g.body.style, l = !1, n = !1;
        if (h) {
          for (var p in h)
            if (l = m.exec(p)) {
              k = l[0];
    ...
    return function (b, a, c) {
      ...
      'function' !== d && (c = 'boolean' === d && c ? function (a, b) {
        ...
        if (a && b && 'object' === typeof a && 'object' === typeof b) {
          for (var d in a)
            if ('$' !== d.charAt(0) && zb.call(a, d) && c(a[d], b[d]))
              return !0;
          return !1;
        }
        b = ('' + b).toLowerCase();
  ...
  function Nc(b, a, c, d, e) {
    ...
    if (h)
      ...
      if (f.length >= n + p)
        for (l = f.length - n, h = 0; h < l; h++)
          0 === (l - h) % p && 0 !== h && (k += c), k += f.charAt(h);
      for (h = l; h < f.length; h++)
        0 === (f.length - h) % n && 0 !== h && (k += c), k += f.charAt(h);
      for (; b.length < e;)
        b += '0';
  ...
  function Kc(b) {
    ...
    return function (c, e) {
      ...
      if (!Na(c))
        return c;
      for (; e;)
        (m = Ie.exec(e)) ? (f = f.concat(ya.call(m, 1)), e = f.pop()) : (f.push(e), e = null);
      q(f, function (a) {
        k = Je[a];
  ...
  function Pc(b, a, c, d) {
    ...
    g.$setValidity = function (a, b, c) {
      var d = m[a];
      if (b)
        d && (Pa(d, c), d.length || (k--, k || (e(b), g.$valid = !0, g.$invalid = !1), m[a] = !1, e(!0, a), f.$setValidity(a, !0, g)));
      else {
        k || e(b);
        if (d) {
          if (-1 != Oa(d, c))
  ...
  function xb(b, a, c, d, e, g) {
    var f = a.prop('validity'), k = a[0].placeholder, m = {};
    if (!e.android) {
      var h = !1;
    ...
    var l = function (e) {
      if (!h) {
        var g = a.val();
        if (S && 'input' === (e || m).type && a[0].placeholder !== k)
          k = a[0].placeholder;
        else if (Ra(c.ngTrim || 'T') && (g = aa(g)), d.$viewValue !== g || f && '' === g && !f.valueMissing)
    ...
    r && ((e = r.match(/^\/(.*)\/([gim]*)$/)) ? (r = RegExp(e[1], e[2]), e = function (a) {
      ...
      var e = b.$eval(r);
      if (!e || !e.test)
        throw t('ngPattern')('noregexp', r, e, ga(a));
  ...
  var L = function (b) {
    ...
    }, S, w, Ba, ya = [].slice, Le = [].push, wa = Object.prototype.toString, Qa = t('ng'), Sa = T.angular || (T.angular = {}), Ua, La, ja = [
      '0',
      '0',
      '0'
    ];
  ...
  var Xc = /[A-Z]/g, $c = {
    ...
    }, Wa = T.document.removeEventListener ? function (b, a, c) {
  ...
  q({
    ...
    inheritedData: lb,
    scope: function (b) {
      return w(b).data('$scope') || lb(b.parentNode || b, [
        '$isolateScope',
        '$scope'
      ]);
    },
    ...
    attr: function (b, a, c) {
      ...
      if (mb[d])
        if (B(c))
          ...
          return b[a] || (b.attributes.getNamedItem(a) || y).specified ? d : s;
      else if (B(c))
        b.setAttribute(a, c);
  ...
  q({
    ...
    R.prototype[c] = function (c, e, g) {
      for (var f, k = 0; k < this.length; k++)
        D(f) ? (f = a(this[k], c, e, g), B(f) && (f = w(f))) : Ib(f, a(this[k], c, e, g));
      return B(f) ? f : this;
    };
  ...
  var pe = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, qe = /,/, re = /^\s*(_?)(\S+?)\1\s*$/, oe = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, Za = t('$injector'), Me = t('$animate'), Ld = [
      '$provide',
      function (a) {
        this.$$selectors = {};
  ...
  var ue = /^(x[\:\-_]|data[\:\-_])/i, zc = t('$interpolate'), Ne = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, xe = {
      http: 80,
      https: 443,
      ftp: 21
    }, Pb = t('$location');
  ...
  Tb.prototype = {
    ...
    readString: function (a) {
      ...
      for (var d = '', e = a, g = !1; this.index < this.text.length;) {
        ...
        if (g)
          'u' === f ? (f = this.text.substring(this.index + 1, this.index + 5), f.match(/[\da-f]{4}/i) || this.throwError('Invalid unicode escape [\\u' + f + ']'), this.index += 4, d += String.fromCharCode(parseInt(f, 16))) : d = (g = Oe[f]) ? d + g : d + f, g = !1;
        else if ('\\' === f)
          g = !0;
        else {
          if (f === a) {
  ...
  q([
    ...
    Eb[c] = function () {
      return {
        ...
        link: function (d, e, g) {
          var f = a, k = a;
          'href' === a && '[object SVGAnimatedString]' === wa.call(e.prop('href')) && (k = 'xlinkHref', g.$attr[k] = 'xlink:href', f = null);
  ...
  var Qc = function (a) {
      ...
      number: function (a, c, d, e, g, f) {
        ...
        e.$formatters.push(function (a) {
          return qa(e, 'number', e.$isEmpty(a) || yb(a), a);
        });
      },
    ...
    ], ub = 'ng-valid', tb = 'ng-invalid', Ma = 'ng-pristine', wb = 'ng-dirty', Se = [
      '$scope',
      '$exceptionHandler',
      '$attrs',
      '$element',
      ...
      function (a, c, d, e, g, f) {
        ...
        if (!h)
          throw t('ngModel')('nonassign', d.ngModel, ga(e));
        this.$render = y;
  ...
  var sd = [
        ...
        return {
          ...
          link: function (c, d, e, g, f) {
            ...
            c.$watch(e.ngIf, function (g) {
              ...
              })) : (h && (h.remove(), h = null), m && (m.$destroy(), m = null), k && (h = Db(k.clone), a.leave(h, function () {
                h = null;
              }), k = null));
            });
          }
          ...
          link: function (e, g, f, k, m) {
            ...
            e.$watchCollection(k, function (a) {
              ...
              if (db(a))
                ...
                C = [];
                for (H in a)
                  a.hasOwnProperty(H) && '$' != H.charAt(0) && C.push(H);
                C.sort();
              }
              E = C.length;
              k = D.length = C.length;
              for (f = 0; f < k; f++)
                if (H = a === C ? f : C[f], t = a[H], t = n(H, t, f), Aa(t, '`track by` id'), B.hasOwnProperty(t))
                  y = B[t], delete B[t], u[t] = y, D[f] = y;
                else {
                  if (u.hasOwnProperty(t))
                    throw q(D, function (a) {
                      a && a.scope && (B[a.id] = a);
                    }), d('dupes', h, t);
                  D[f] = { id: t };
                  u[t] = !1;
              ...
              for (H in B)
                B.hasOwnProperty(H) && (y = B[H], f = Db(y.clone), c.leave(f), q(f, function (a) {
                  a.$$NG_REMOVED = !0;
                }), y.scope.$destroy());
              f = 0;
      ...
      link: function (a, c, d, e, g) {
        if (!g)
          throw t('ngTransclude')('orphan', ga(c));
        g(function (a) {
          c.empty();
          c.append(a);
        });
    ...
    ], Ue = t('ngOptions'), Dd = $({ terminal: !0 }), fd = [
      '$compile',
      '$parse',
      function (a, c) {
          ...
          link: function (e, f, k, m) {
            ...
            function n(e, f, g) {
              function k() {
                ...
                if (r)
                  if (x && O(t))
                    for (s = new Ya([]), A = 0; A < t.length; A++)
                      K[m] = t[A], s.put(x(e, K), t[A]);
                  else
                    s = new Ya(t);
                ...
                for (D = c.length; K < D; K++) {
                  ...
                  z.length <= K ? (t = {
                    ...
                    label: h.label
                  }, v = [t], z.push(v), f.append(t.element)) : (v = z[K], t = v[0], t.label != d && t.element.attr('label', t.label = d));
                  E = null;
                  A = 0;
                  for (F = h.length; A < F; A++)
                    s = h[A], (d = v[A + 1]) ? (E = d.element, d.label !== s.label && E.text(d.label = s.label), d.id !== s.id && E.val(d.id = s.id), d.selected !== s.selected && E.prop('selected', d.selected = s.selected)) : ('' === s.id && y ? J = y : (J = u.clone()).val(s.id).attr('selected', s.selected).text(s.label), v.push({
                      element: J,
                      label: s.label,
                      id: s.id,
                      selected: s.selected
              ...
              f.on('change', function () {
                e.$apply(function () {
                  ...
                  if (r)
                    for (k = [], p = 0, u = z.length; p < u; p++)
                      for (a = z[p], l = 1, t = a.length; l < t; l++) {
            ...
            if (m[1]) {
              ...
              k = 0;
              for (var z = f.children(), J = z.length; k < J; k++)
                if ('' === z[k].value) {
                  x = y = z.eq(k);
                  break;
                }
...
(function (e, t, r) {
  ...
  function n(r) {
    ...
    })(), Gt ? (st = t.getElementById('skrollr-body'), st && at(), X(), Dt(o, [
      y,
      S
    ], [T])) : Dt(o, [
      y,
  ...
  var o, a, i = {
      ...
      VERSION: '0.6.26'
    }, l = Object.prototype.hasOwnProperty, s = e.Math, c = e.getComputedStyle, f = 'touchstart', u = 'touchmove', m = 'touchcancel', p = 'touchend', d = 'skrollable', g = d + '-before', v = d + '-between', h = d + '-after', y = 'skrollr', T = 'no-' + y, b = y + '-desktop', S = y + '-mobile', k = 'linear', w = 1000, x = 0.004, E = 200, A = 'start', F = 'end', C = 'center', D = 'bottom', H = '___skrollable_id', I = /^(?:input|textarea|button|select)$/i, P = /^\s+|\s+$/g, N = /^data(?:-(_\w+))?(?:-?(-?\d*\.?\d+p?))?(?:-?(start|end|top|center|bottom))?(?:-?(top|center|bottom))?$/, O = /\s*(@?[\w\-\[\]]+)\s*:\s*(.+?)\s*(?:;|$)/gi, V = /^(@?[a-z\-]+)\[(\w+)\]$/, z = /-([a-z0-9_])/g, q = function (e, t) {
      ...
      return (Gt || !t) && (t = function (t) {
        var n = Pt() - r, o = s.max(0, 1000 / 60 - n);
              ...
              if ('data-edge-strategy' !== g.name)
                if ('data-emit-events' !== g.name) {
                  ...
                  if (null !== v) {
                    ...
                    var b = v[3], S = v[4] || b;
                    b && b !== A && b !== F ? (h.mode = 'relative', h.anchors = [
                      b,
                      S
                    ]) : (h.mode = 'absolute', b === F ? h.isEnd = !0 : h.isPercentage || (h.offset = h.offset * Vt));
                  }
                } else
                  u = !0;
              else
  ...
  var X = function () {
      ...
      St(o, [
        ...
        case p:
          ...
          var E = h / S;
          E = s.max(s.min(E, 3), -3);
          var A = s.abs(E / mt), F = E * A + 0.5 * mt * A * A, C = it.getScrollTop() - F, D = 0;
          C > Ot ? (D = (Ot - C) / F, C = Ot) : 0 > C && (D = -C / F, C = 0), A *= 1 - D, it.animateTo(0 | C + 0.5, {
            easing: 'outCubic',
            duration: A
          });
        }
      ...
      for (var r = 0, n = lt.length; n > r; r++) {
        ...
        if (T || b) {
          ...
          switch (T ? (Dt(c, [g], [
              h,
              v
            ]), k && w > -1 && (xt(c, p.eventType, zt), s.lastFrameIndex = -1)) : (Dt(c, [h], [
              g,
              v
            ]), k && m > w && (xt(c, y.eventType, zt), s.lastFrameIndex = m)), s.edge = T ? -1 : 1, s.edgeStrategy) {
          case 'reset':
            ot(c);
            continue;
          case 'ease':
